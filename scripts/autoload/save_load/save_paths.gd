...
const world_map_save = "user://world_map.res"
const biome_map_save = "user://biome_map.res"
const world_monster_map_save = "user://world_monster_map.res"
const dungeon_map_save = "user://dungeon_map.res"